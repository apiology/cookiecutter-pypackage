...
description: >-
  Sync boilerplate for this cookiecutter template (cookiecutter-pypackage,
  PyPackage) from reference repos using only origin/main;
...
**This template:** `cookiecutter-pypackage` — PyPackage cookiecutter.
...
- Port from reference repos only what fits **this** tier (PyPackage).
...
|------|--------------|--------|
| Meta | `cookiecutter-cookiecutter` | Bakes child templates; sync docs live under baked `cookiecutter-pypackage/` |
| Language/tool | `cookiecutter-ruby` | PyPackage boilerplate |
...
- Cookiecutter vars: `cookiecutter-pypackage`, `PyPackage`
